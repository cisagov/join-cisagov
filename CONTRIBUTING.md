...
issue](https://github.com/cisagov/join-cisagov/issues) in this
...
request](https://github.com/cisagov/join-cisagov/pulls), you will
...
```console
cd join-cisagov
pyenv virtualenv <python_version_to_use> join-cisagov
pyenv local join-cisagov
